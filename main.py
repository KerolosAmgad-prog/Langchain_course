...
"""
    ...
    summary_prompt_templates=PromptTemplate(input_variables=["information"],template=summary_template)
    llm =ChatOpenAI(temperature=0 , model="gpt-4o")
    chain=summary_prompt_templates | llm   # that is LCEL , the | is like an arrow ->
